        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($kategori)
                ...
                ->addColumn('aksi', function ($row) {
                    ...
                    $btn = $btn . ' <a href="javascript:void(0)" data-toggle="tooltip"  data-id="' . $row->id . '" title="Hapus" class="btn btn-danger btn-sm hapus-kategori"><i class="nav-icon fas fa-trash" style="width:15px"></i></a>';                    return $btn;
                })
                ->addColumn('foto', function ($data) {
                    $img = '<img src="/assets/img/kategori/' . $data->foto . '" alt="" width="100%" height="15%">';
                    return $img;
                })
