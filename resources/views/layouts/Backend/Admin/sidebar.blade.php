    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item ">
            <a href="{{url('/admin/artikel')}}" class="nav-link {{ Request::segment(1) == 'admin/artikel'? 'active':''}}">
              <i class="nav-icon fas fa-th"></i>
              <p>Blog Artikel</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="{{url('/admin/kategori')}}" class="nav-link {{ Request::segment(1) == '/admin/kategori'? 'active':''}}">
              <i class="nav-icon fas fa-th"></i>
              <p>Kategori</p>
            </a>
          </li>
